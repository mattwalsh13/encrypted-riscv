...
entry:
  ...
  %0 = call i32 @llvm.riscv.factorial(i32 6)
  store i32 %0, ptr %j, align 4
  ret i32 0
}

; Function Attrs: nounwind speculatable willreturn memory(none)
declare i32 @llvm.riscv.factorial(i32) #1
...
!5 = !{!"clang version 23.0.0git (https://github.com/mattwalsh13/encrypted-riscv.git dbc4bcd4d2553526027c3f2fa9895ba29271e429)"}
