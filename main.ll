...
define dso_local i32 @addDouble(i32 %a.coerce, i32 %b.coerce) #0 {
entry:
  ...
  %__add_enc_r4 = alloca i32, align 4
  ...
  %v2 = getelementptr inbounds nuw %struct.int_enc, ptr %b, i32 0, i32 0
  ...
  %v3 = getelementptr inbounds nuw %struct.int_enc, ptr %c, i32 0, i32 0
  %4 = load i32, ptr %__add_enc_r, align 4
  store i32 %4, ptr %v3, align 4
  %v5 = getelementptr inbounds nuw %struct.int_enc, ptr %c, i32 0, i32 0
  %5 = load i32, ptr %v5, align 4
  %v6 = getelementptr inbounds nuw %struct.int_enc, ptr %b, i32 0, i32 0
  %6 = load i32, ptr %v6, align 4
  %7 = call i32 @llvm.riscv.add.enc(i32 %5, i32 %6)
  store i32 %7, ptr %__add_enc_r4, align 4
  %8 = load i32, ptr %__add_enc_r4, align 4
  call void asm sideeffect "", "r,~{memory}"(i32 %8) #3, !srcloc !7
  %v7 = getelementptr inbounds nuw %struct.int_enc, ptr %retval, i32 0, i32 0
  %9 = load i32, ptr %__add_enc_r4, align 4
  store i32 %9, ptr %v7, align 4
  %coerce.dive8 = getelementptr inbounds nuw %struct.int_enc, ptr %retval, i32 0, i32 0
...
entry:
  ...
  %coerce.dive10 = getelementptr inbounds nuw %struct.int_enc, ptr %y, i32 0, i32 0
  %15 = load i32, ptr %coerce.dive10, align 4
  %call = call i32 @addDouble(i32 %14, i32 %15)
  %coerce.dive11 = getelementptr inbounds nuw %struct.int_enc, ptr %tmp, i32 0, i32 0
  store i32 %call, ptr %coerce.dive11, align 4
